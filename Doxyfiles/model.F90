!>@defgroup Description
 !!@brief In the current code, which represents the main, the changes needed to make the code work with input file are included.
 !!@brief Also the Timings outputs (with the corresponding variables) were added.
 !!@{
