...
!! @brief In the current code, we added the preprocessing directives needed to make the code run in parallel with OpenMP. In particular, the loops 
!! @brief inside the following subroutines were parallelized:
!! @brief update, xtend, ztend
